...
public interface RpcInterface {
    ...
    String signTransaction(@JsonRpcParam(value="tx") Map<String, Object> jsonTx, @JsonRpcParam(value="privkey") String privKey);

    @JsonRpcMethod("serialize")
    String serialize(@JsonRpcParam(value="jsontx") Map<String, Object> jsonTx);

    @JsonRpcMethod("broadcast")
    String broadcastTransaction(@JsonRpcParam(value="tx") String txHex);
